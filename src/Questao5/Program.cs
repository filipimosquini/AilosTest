...
using Questao5.Infrastructure.Configurations.Validations;
using Questao5.Infrastructure.CrossCutting.MessageCatalogs;
using Questao5.Infrastructure.CrossCutting.MessageCatalogs.Interfaces;
using Questao5.Infrastructure.Database.CommandStore.Movements;
using Questao5.Infrastructure.Database.Configs.Sqlite;
using Questao5.Infrastructure.Database.QueryStore.Movements;
